        ...
        def process(self, data=None):
            ...
            while True:
                ...
                if cmd == MSG_RSP:
                    ...
                    print(args)
                    '''try:
                        feed=url.get("https://blynk.cloud/external/api/update?token=Dl94khlZdrzBnhfyz1UMNi4ptxE2VMfO&V"+args[1]+"="+args[2])
                        feed.close()
                    except:pass
                    print(feed)'''
                    if(args[1]!='0'):
...
WIFI_SSID = 'JioFiber-5SgsR'
WIFI_PASS = 'prernamansion5'

BLYNK_TEMPLATE_NAME="Angle Vertex"
BLYNK_AUTH="NGtyYuFErn42hGzqIw4PrS454KWA0Vf1"
